    ...
    <main className="min-h-dvh bg-[var(--color-bg)] pb-16">
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 py-4 rounded-xl font-medium transition ${
            saved
              ? "bg-green-100 text-green-700"
              : "bg-[var(--color-accent)] text-white active:scale-95"
          }`}
        >
          <Icon
            icon={ArrowDownTrayIcon}
            size={20}
            className={saved ? "text-green-700" : "text-white"}
          />
          {saved
            ? "Opgeslagen in jouw recepten!"
            : saving
              ? "Opslaan..."
