export const styles = {
  button: {
    ...
    save: "bg-[var(--color-accent)]/90 border border-[var(--color-accent)]/90 text-white px-8 py-4 rounded-full shadow-lg text-md font-semibold active:scale-95 transition",
