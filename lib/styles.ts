export const styles = {
  button: {
    ...
    aigenerate: "bg-[rgb(var(--color-secondaccent))] text-white px-8 py-4 rounded-full font-semibold active:scale-95 transition",
    ...
    save: "w-full bg-[var(--color-accent)]/95 border border-[var(--color-accent)]/95 text-white px-8 py-4 rounded-full text-md font-semibold active:scale-95 transition",
